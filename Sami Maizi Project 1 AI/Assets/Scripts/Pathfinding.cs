...
public class Pathfinding : MonoBehaviour
{
	...
	void Update()
	{
		...
		Debug.Log($"Execution Time A* Euclidian: {watchAstarEuclidian.ElapsedMilliseconds} ms, retracement : {aeuccnt}\nExecution Time A* Manhattan: {watchAstarManhattan.ElapsedMilliseconds} ms, retracement : {asmancnt}\nExecution Time UCS: {watchUCS.ElapsedMilliseconds} ms, retracement : {ucscnt}\nExecution Time BFS: {watchBFS.ElapsedMilliseconds} ms, retracement : {bfscnt}\nExecution Time DFS: {watchDFS.ElapsedMilliseconds} ms, retracement : {dfscnt}");
	}
